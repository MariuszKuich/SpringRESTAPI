...
public class StudentRestController {
    ...
    @GetMapping(value = "/studenci", params="indeks")
    ResponseEntity<Student> getStudentByNrIndeksu(@RequestParam String indeks) {
        return ResponseEntity.of(studentService.searchByNrIndeksu(indeks));
    }

    @GetMapping(value = "/studenci", params="nazwisko")
    Page<Student> getStudentByNazwiskoStartsWith(@RequestParam String nazwisko, Pageable pageable) {
